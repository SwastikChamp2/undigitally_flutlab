Message from Swastik: The lengthiest and bulkiest code of all, took a while to debug all its error from stack overflow and also run a pub get .
                      Still limited to Sign in and Sign up page. Claims Feed page is missing.   Website: https://flutlab.io

# Undigitally%20Frontend
